...
\subtitle
{Causal Evidence from Political Science and Economics} % (optional)
...
%\begin{itemize}
%\item Naive OLS shows 11-13 more citations.
%\item 28-45\% more citations.
%\item 2SLS shows positive (13\%) but very noisy, underpowered evidence of causality.
%\end{itemize}
%\end{frame}
...
{ % all template changes are local to this group.
    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
            \node[at=(current page.center)] {
                \includegraphics[width=\paperwidth]{../output/econ_availyn_time_data_nopp.png}
            };
        \end{tikzpicture}
     \end{frame}
}
...
{ % all template changes are local to this group.
    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
            \node[at=(current page.center)] {
                \includegraphics[width=\paperwidth]{../output/ps_availyn_time_dataarticle.png}
            };
        \end{tikzpicture}
     \end{frame}
}
...
\begin{frame}{Preliminary Conclusions}
  ...
  \begin{itemize}
  \item
    Top econ \& political science papers with public data \& code are cited more (35-50 cites, 30-45\%).
  \item
    ...
    \end{itemize}
    \item
    Tentative: IV estimates, which can reduce attenuation bias, even larger.
  \end{itemize}
\end{frame}
