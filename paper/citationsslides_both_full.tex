...
\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum3-simp_yn_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum3-simp_yn_FE.tex}}
\end{frame}


\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum3-simp_yn_NoT.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum3-simp_data_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum3-simp_data_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum3-simp_data_NoT.tex}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum3-simp_yn_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum3-simp_yn_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum3-simp_yn_NoT.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum3-simp_data_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum3-simp_data_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum3-simp_data_NoT.tex}}
\end{frame}
...
\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum5-simp_yn_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum5-simp_yn_FE.tex}}
\end{frame}


\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum5-simp_yn_NoT.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum5-simp_data_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum5-simp_data_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_naivecum5-simp_data_NoT.tex}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum5-simp_yn_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum5-simp_yn_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum5-simp_yn_NoT.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum5-simp_data_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum5-simp_data_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.3}{\input{../output/both_ivregcum5-simp_data_NoT.tex}}
\end{frame}
