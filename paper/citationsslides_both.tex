...
\begin{frame}{}
\scalebox{0.65}{\input{../output/both_naive_yn_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.65}{\input{../output/both_naive_yn_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.65}{\input{../output/both_naive_data_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.65}{\input{../output/both_naive_data_FE.tex}}
\end{frame}
...
\begin{frame}{}
\scalebox{0.83}{\input{../output/both_naiveLN-simp.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.90}{\input{../output/both_first.tex}}
Controls cut for space
\end{frame}

\begin{frame}{}
\scalebox{0.65}{\input{../output/both_ivreg_yn_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.65}{\input{../output/both_ivreg_yn_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.65}{\input{../output/both_ivreg_data_months.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.65}{\input{../output/both_ivreg_data_FE.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.8}{\input{../output/both_ivreg-simp.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.5}{\input{../output/both_ivregLN.tex}}
\end{frame}

\begin{frame}{}
\scalebox{0.8}{\input{../output/both_ivregLN-simp.tex}}
\end{frame}
...
\begin{frame}{}
\scalebox{0.61}{\input{../output/both_exclusion.tex}}
