...
*GENERATE AER P&P ISSUES
gen aerpnp=(publication_date=="2001/05/01" | ///
...
*GRAPH AVAIL FOR ONLY NON-AERP&P ARTICLES
gen avail_yn_nonpnp=avail_yn if aerpnp==0
bysort year aer: egen avail_j_avg_nonpnp=mean(avail_yn_nonpnp)
label var avail_j_avg_nonpnp "Availability by Journal and Year, Non-P&P Articles"
gen aer_y_avg_nonpnp=avail_j_avg_nonpnp if aer==1
label var aer_y_avg_nonpnp "AER"
gen qje_y_avg_nonpnp=avail_j_avg_nonpnp if aer==0
label var qje_y_avg_nonpnp "QJE"
line aer_y_avg_nonpnp qje_y_avg_nonpnp year, title("Yearly Average Availability by Journal, Non-P&P Articles") ///
	bgcolor(white) graphregion(color(white)) ///
	ylabel(0 0.2 0.4 0.6 0.8 1)
graph export ../output/econ_avail_time_nonpnp.eps, replace

*GRAPH AVAIL FOR ONLY DATA-HAVING AND NON-AERP&P ARTICLES
gen avail_yn_data_nonpnp=avail_yn if data_type!="no_data" & aerpnp==0
bysort year aer: egen avail_j_avg_data_nonpnp=mean(avail_yn_data_nonpnp)
label var avail_j_avg_data_nonpnp "Availability by Journal and Year, Non-P&P Data Articles"
gen aer_y_avg_data_nonpnp=avail_j_avg_data_nonpnp if aer==1
label var aer_y_avg_data_nonpnp "AER"
gen qje_y_avg_data_nonpnp=avail_j_avg_data_nonpnp if aer==0
label var qje_y_avg_data_nonpnp "QJE"
line aer_y_avg_data_nonpnp qje_y_avg_data_nonpnp year, title("Yearly Average Availability by Journal, Non-P&P Data Articles") ///
	bgcolor(white) graphregion(color(white)) ///
	ylabel(0 0.2 0.4 0.6 0.8 1)
graph export ../output/econ_avail_time_data_nonpnp.eps, replace
...
histogram citation if data_type!="no_data", bgcolor(white) graphregion(color(white)) title("Density of Citations, Data Articles")
graph export ../output/econ_cite_histo_dataarticle.eps, replace

histogram citation if aerpnp==0, bgcolor(white) graphregion(color(white)) title("Density of Citations, Non-P&P Articles")
graph export ../output/econ_cite_histo_nonpnp.eps, replace
...
bysort year aer: egen cite_j_avg_dataarticle=mean(citation) if data_type!="no_data"
label var cite_j_avg_dataarticle "Cites by Journal and Year, Data Articles"
gen aer_y_citeavg_dataarticle=cite_j_avg_dataarticle if aer==1
label var aer_y_citeavg_dataarticle "AER"
gen qje_y_citeavg_dataarticle=cite_j_avg_dataarticle if aer==0
label var qje_y_citeavg_dataarticle "QJE"
line aer_y_citeavg_dataarticle qje_y_citeavg_dataarticle year, title("Yearly Average Citations by Journal, Data Articles") ///
	bgcolor(white) graphregion(color(white))
graph export ../output/econ_cite_time_dataarticle.eps, replace

bysort year aer: egen cite_j_avg_nonpnp=mean(citation) if aerpnp==0
label var cite_j_avg_nonpnp "Cites by Journal and Year, Non-P&P Articles"
gen aer_y_citeavg_nonpnp=cite_j_avg_nonpnp if aer==1
label var aer_y_citeavg_nonpnp "AER"
gen qje_y_citeavg_nonpnp=cite_j_avg_nonpnp if aer==0
label var qje_y_citeavg_nonpnp "QJE"
line aer_y_citeavg_nonpnp qje_y_citeavg_nonpnp year, title("Yearly Average Citations by Journal, Non-P&P Articles") ///
	bgcolor(white) graphregion(color(white))
graph export ../output/econ_cite_time_nonpnp.eps, replace
...
graph bar topic_*, stack over(aer) legend(lab(1 "Micro") ///
									...
									lab(6 "Finance") ///
									lab(7 "Other")) ///
									title("Article Topic by Journal") 
graph export ../output/econ_topicXjournal.eps, replace

graph bar topic_* if data_type!="no_data", stack over(aer) 
									legend(lab(1 "Micro") ///
									lab(2 "Macro") ///
									lab(3 "Labor") ///
									lab(4 "Health") ///
									...
									lab(6 "Finance") ///
									lab(7 "Other")) ///
									title("Article Topic by Journal, Data Articles") 
graph export ../output/econ_topicXjournal_dataarticle.eps, replace

graph bar topic_* if aerpnp==0, stack over(aer) ///
									legend(lab(1 "Micro") ///
									lab(2 "Macro") ///
									lab(3 "Labor") ///
									lab(4 "Health") ///
									...
									lab(6 "Finance") ///
									lab(7 "Other")) ///
									title("Article Topic by Journal, Non-P&P Articles") 
graph export ../output/econ_topicXjournal_nonpnp.eps, replace
...
foreach X in 2005 {
graph bar topic_* if data_type!="no_data", stack over(post`X') over(aer) ///  
									legend(lab(1 "Micro") ///
									lab(2 "Macro") ///
									lab(3 "Labor") ///
									lab(4 "Health") ///
									...
									lab(6 "Finance") ///
									lab(7 "Other")) ///
	title("Article Topic by Journal" "Before and After `X' Policy, Data Articles") ///
	bgcolor(white) graphregion(color(white))
graph export ../output/econ_topicXjournalXpost`X'_dataarticle.eps, replace
}

foreach X in 2005 {
graph bar topic_* if aerpnp==0, stack over(post`X') over(aer) ///
									legend(lab(1 "Micro") ///
									lab(2 "Macro") ///
									lab(3 "Labor") ///
									lab(4 "Health") ///
									...
									lab(6 "Finance") ///
									lab(7 "Other")) ///
	title("Article Topic by Journal" "Before and After `X' Policy, Non-P&P Articles") ///
	bgcolor(white) graphregion(color(white))
graph export ../output/econ_topicXjournalXpost`X'_nonpnp.eps, replace
}
...
foreach X in 2005{
graph bar data_type_* if data_type!="no_data", stack over(post`X') over(aer)  legend(lab(1 "Experimental") ///
	lab(2 "None") ///
	lab(3 "Observational") ///
	lab(4 "Simulations")) ///
	title("Data Type by Journal" "Before and After `X' Policy, Data Articles") ///
	bgcolor(white) graphregion(color(white))
graph export ../output/econ_typeXjournalXpost`X'_dataarticle.eps, replace
}

foreach X in 2005{
graph bar data_type_* if aerpnp==0, stack over(post`X') over(aer)  legend(lab(1 "Experimental") ///
	lab(2 "None") ///
	lab(3 "Observational") ///
	lab(4 "Simulations")) ///
	title("Data Type by Journal" "Before and After `X' Policy, Non-P&P Articles") ///
	bgcolor(white) graphregion(color(white))
graph export ../output/econ_typeXjournalXpost`X'_nonpnp.eps, replace
}
...
label var top_rank "Top US News Ranking of Author Institutions"
histogram top_rank if data_type!="no_data", ///
	title("Top US News Ranking of Articles, Data Articles") ///
	bgcolor(white) graphregion(color(white)) ///
	note("*Rank of 125 implies no author at top-100 ranked institution")
graph export ../output/histo_authrank_dataarticle.eps, replace

label var top_rank "Top US News Ranking of Author Institutions"
histogram top_rank if aerpnp==0, ///
	title("Top US News Ranking of Articles, Non-P&P Articles") ///
	bgcolor(white) graphregion(color(white)) ///
	note("*Rank of 125 implies no author at top-100 ranked institution")
graph export ../output/histo_authrank_nonpnp.eps, replace
...
foreach X in 2005{
graph bar top1 top5 top20 top50 top100 unranked if data_type!="no_data", stack over(post`X') over(aer)  legend(lab(1 "Top 1*") ///
	lab(2 "Top 10") ///
	lab(3 "Top 20") ///
	lab(4 "Top 50") ///
	lab(5 "Top 100") ///
	lab(6 "Unranked")) ///
	title("Institution Rankings by Journal" "Before and After `X' Policy, Data Articles") ///
	bgcolor(white) graphregion(color(white))
graph export ../output/econ_rankXjournalXpost`X'_dataarticle.eps, replace
}

foreach X in 2005{
graph bar top1 top5 top20 top50 top100 unranked if aerpnp==0, stack over(post`X') over(aer)  legend(lab(1 "Top 1*") ///
	lab(2 "Top 10") ///
	lab(3 "Top 20") ///
	lab(4 "Top 50") ///
	lab(5 "Top 100") ///
	lab(6 "Unranked")) ///
	title("Institution Rankings by Journal" "Before and After `X' Policy, Non-P&P Articles") ///
	bgcolor(white) graphregion(color(white))
graph export ../output/econ_rankXjournalXpost`X'_nonpnp.eps, replace
}
