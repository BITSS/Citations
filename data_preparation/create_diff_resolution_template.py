...
resolution_pairs=[('MG', 'TC'), ('MG', 'MS'), ('MG', 'DS'), ('MG', 'MH')]

input_file = 'bld/qje_reference_coding_diff.csv'
output_file_prefix = 'bld/qje_reference_coding_diff_resolution'
...
for pair in resolution_pairs:
    ...
    output_columns = (['article_ix', 'reference_ix', 'publication_date', 'doi',
                       'title', 'context', 'match'] +
                      entry_columns + [resolution_column,
                                       conflict_column])
